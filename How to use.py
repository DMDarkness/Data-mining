...
import fp2ar#import the module to generate rules from frequent patterns
...
ar=fp2ar.getAR(fi, len(dataset), 0.7, 1)#form association rules from frequent pattern
"""
